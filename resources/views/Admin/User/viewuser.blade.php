                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="bullet-line-list">
                                    <li>
                                        <h6>{{__('admin_user.phone')}}</h6>
                                        <p class="mb-0">{{ isset($user->phone)?$user->phone  :'' }}</p>
                                        <p class="text-muted">
                                    ...
                                    <li>
                                        <h6>{{__('admin_user.address')}}</h6>
                                        <p class="mb-0">{{ isset($user->userDetails)?$user->userDetails->flat_no."," :'' }} 
                                            
                                            {{ isset($user->userDetails)?$user->userDetails->address:'' }}</p>
                                        <p class="text-muted"> 
                                        </p>
                                    </li>
                                    <li>
                                        <h6>{{__('admin_user.role')}}</h6>
                                        <p class="mb-0">
                                            @if(is_object($roles))
                            ...
                            <!-- Socail Accounts section Start -->
                            @if($user->total_social>0)
                            <div class="card-body">
                                <h4 class="card-title">{{__('admin_user.social_account')}}</h4>
                                <ul class="bullet-line-list">
                                    @foreach($user->social_accounts as $data)
                                    <li>
                                        <h6>{{ $data->provider }}</h6>
                                        <p class="mb-0"></p>
                                        <p class="text-muted">
